...
Clone_of_rehouizd_pipeline = Job.from_dict(
    {
...
w = WorkspaceClient()
w.jobs.reset(new_settings=Clone_of_rehouizd_pipeline, job_id=250754220870540)
# or create a new job using: w.jobs.create(**Clone_of_rehouizd_pipeline.as_shallow_dict())
