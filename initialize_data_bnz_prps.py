...
path_dst = f"/Volumes/rehouzd_db/bronze/bronze_volume/data_rehouzd_mvp/{current_date}/{run_id}"
try:
...
for i in range(num_chunks):
    ...
    chunk_df.to_csv(f"{path_dst}/synthetic_investor_data_part_{i+1}.csv", index=False)
